...
// testMonopoly
List testMonopoly(int numGames, int maxTurns, int sides, int numDice, int cores);
RcppExport SEXP _partyGames_testMonopoly(SEXP numGamesSEXP, SEXP maxTurnsSEXP, SEXP sidesSEXP, SEXP numDiceSEXP, SEXP coresSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type numGames(numGamesSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type numDice(numDiceSEXP);
    Rcpp::traits::input_parameter< int >::type cores(coresSEXP);
    rcpp_result_gen = Rcpp::wrap(testMonopoly(numGames, maxTurns, sides, numDice, cores));
    return rcpp_result_gen;
END_RCPP
}
// twoCoinDieElephant
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_partyGames_testMonopoly", (DL_FUNC) &_partyGames_testMonopoly, 5},
