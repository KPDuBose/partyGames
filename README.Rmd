...
Note: We are attempting to integrate OpenMP into the code to facilitate parallelization of the code and allow faster responses times for the simulation. This is not consistent yet and we recomend that users do not attempt to parallelize the code yet.
